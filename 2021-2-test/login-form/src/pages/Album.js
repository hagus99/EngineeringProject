    ...
    return (
        <div className="main">
            ...
            <section className="top-section">
                <div class="container d-flex flex-column align-items-center my-5 px-5 text-center">
                    <h1 className="fw-light">Album example</h1>
                    <p class="lead text-muted w-75 px-3 py-2">
                        Something short and leading about the collection below—its contents, the creator, etc. Make it short and sweet, but not too short so folks don’t simply skip over it entirely.
                    </p>
                    <div class="d-flex">
                        <button class="btn btn-primary mx-2 mainBtn">
                            Main call to action
                        </button>
                        <button class="btn btn-secondary mx-2 mainBtn">
                            Secondary action
                        </button>
                    </div>
                </div>
